package com.luck.gaia.baselibrary.view.recyclerView.pullToRefresh;
...
import com.luck.gaia.baselibrary.view.recyclerView.wrap.WrapRecyclerView;
...
public class PullToRefreshRecyclerView extends WrapRecyclerView {
    ...
    public void addLoadViewCreator(com.luck.gaia.baselibrary.view.recyclerView.pullToRefresh.LoadViewCreator loadCreator) {
     ...
     * 获取上拉加载的FooterView
     */
    public com.luck.gaia.baselibrary.view.recyclerView.pullToRefresh.LoadViewCreator getLoadViewCreator() {
