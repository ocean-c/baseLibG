package com.luck.gaia.baselibrary.view.banner;
...
public class BannerViewPager extends ViewPager {
    ...
    private com.luck.gaia.baselibrary.view.banner.BannerAdapter mAdapter;
    // 自定义的改变页面切换速度的Scroller类
    private com.luck.gaia.baselibrary.view.banner.BannerScroller mScroller;
