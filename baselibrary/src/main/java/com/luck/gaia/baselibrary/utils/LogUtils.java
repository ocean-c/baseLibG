package com.luck.gaia.baselibrary.utils;


import android.content.Context;

import com.luck.gaia.baselibrary.base.BaseApplication;
...
public class LogUtils {
    ...
    public static void file(String tag, String text) {
        if (Constants.isSaveLog) {
            File logFile = getLogFile(getLogPath(), com.luck.gaia.baselibrary.utils.DateUtils.formatCurrentDate() + ".log");
    ...
    public static void file(Context context, String tag, String text) {
        if (Constants.isSaveLog) {
            File logFile = getLogFile(getLogPath(context), com.luck.gaia.baselibrary.utils.DateUtils.formatCurrentDate() + ".log");
            logToFile(logFile, tag, text);
        }
    }
    ...
    public static void logToFile(final File logFile, final String tag, final String text) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    if (logFile != null) {
                        String needWriteMessage = "\n\n\n\n" + com.luck.gaia.baselibrary.utils.DateUtils.formatCurrentTime() + "    " + tag + "    " + text;
    ...
    public static String getCrashLogName() {
        return "crash_" + com.luck.gaia.baselibrary.utils.DateUtils.formatCurrentDate() + ".log";
    }
