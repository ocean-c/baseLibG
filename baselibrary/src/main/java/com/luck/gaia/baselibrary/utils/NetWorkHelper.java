...
//        return networkInfo.isConnected();
    ...
    public static String getSimOperatorName(Context context) {
        ...
        try {
            ...
            com.luck.gaia.baselibrary.utils.LogUtils.e(TAG, "获取手机运营商信息异常:" + e.getMessage());
            e.printStackTrace();
        }
        return operator;
    }
            ...
            if (niList != null) {
                ...
                for (Object temp : tempList) {
                    ...
                    if ("tun0".equals(networkInterface.getName()) || "ppp0".equals(networkInterface.getName())) {
                        com.luck.gaia.baselibrary.utils.LogUtils.e(TAG, "使用VPN上网，VPN接口名称：" + networkInterface.getName());
