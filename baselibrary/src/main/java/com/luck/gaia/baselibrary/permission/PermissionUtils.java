package com.luck.gaia.baselibrary.permission;
...
public class PermissionUtils {
    ...
    public static void externalStorage(FragmentActivity activity, PermissionCallback permissionCallback) {
        requestPermissions(activity, permissionCallback, com.luck.gaia.baselibrary.permission.PermissionConfig.STORAGE);
    }
