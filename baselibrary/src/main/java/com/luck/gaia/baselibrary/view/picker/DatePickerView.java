package com.luck.gaia.baselibrary.view.picker;
...
import com.luck.gaia.baselibrary.R2;
...
public class DatePickerView extends LinearLayout implements PickerView.OnSelectListener {
    ...
    public boolean setSelectedTime(String dateStr, boolean showAnim) {
        return !StringUtils.isEmpty(dateStr)
                && setSelectedTime(com.luck.gaia.baselibrary.view.picker.DateFormatUtils.str2Long(dateStr, mCanShowPreciseTime), showAnim);
    }
